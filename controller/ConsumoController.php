...
function buscar_nombre_archivo_consumo_rectificar($nombre_archivo,$tabla_bd,$tipo_archivo){
    //echo "ENTRO AL METODO buscar_nombre_archivo_consumo_rectificar"."<br>";
    //echo "RECIBO LAS SIGUIENTES VARIABLES:"."<br>";
    //echo "nombre_archivo = ".$nombre_archivo."<br>";
    //echo "tabla_bd = ".$tabla_bd."<br>";
