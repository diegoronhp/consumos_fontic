    ...
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="text-center">
                ...
                <div align="center"><img src="../index/assets/img/claro.png" width="300" height="130"></div>

                <h1 class="mx-auto my-3 text-uppercase">Consumo Claro</h1>
                <br>
                ...
                <form id="importando" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="btn btn-light">
                            <label for="archivo_claro">Adjuntar archivo .CSV &#129094; </label>
                            <input type="file" id="archivo_claro" name="archivo_claro">
                            <button id="importar_claro" type="button" class="btn btn-dark">Cargar Archivo</button>
                        </div>
                </form>
