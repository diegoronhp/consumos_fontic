...
while($cant_archivos < $limite_archivos){
    ...
    if($rectificando){
        ...
        if($existe){
            ...
            $mensaje_email .= insertar_registros_consumos_archivo_tigo($origen_rectif,$nombre_archivo,$tipo_insercion);
            $mensaje_email .= "</p>";
        ...
        $tipo_insercion = 0;
        $mensaje_email = "<p>El archivo (".$nombre_archivo.") ha sido procesado y los resultados obtenidos son los siguientes: ";
        $mensaje_email .= insertar_registros_consumos_archivo_tigo($origen_nuevos,$nombre_archivo,$tipo_insercion);
        $mensaje_email .= "</p>";
        enviar_correo_usuario($mensaje_email);
